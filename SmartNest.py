...
from sensors.flow import get_flow_rate
import actuators.led as led
from actuators.led import set_alert_led
from actuators.servo import init_servo, open_window, close_window, is_window_open
        ...
        try:
            ...
            if manual_override:
                ...
                if time.time() - last_fan_trigger <= config.FAN_HOLD_TIME:
                    ...
                    fan.off()
                    if is_window_open() and not mqtt.window_manual_override:
                        close_window()
