...
def on_message(client, userdata, msg):
    ...
    global window_manual_override, window_manual_state
    ...
    try:
        ...
        if method == 'setLight':
            ...
            if params is None:
                ...
                # When true/false set manual override for window
                window_manual_override = True
                window_manual_state = bool(params)
                if window_manual_state:
                    open_window()
                else:
                    close_window()
            publish_telemetry({"event": "window_manual_set", "state": params})
